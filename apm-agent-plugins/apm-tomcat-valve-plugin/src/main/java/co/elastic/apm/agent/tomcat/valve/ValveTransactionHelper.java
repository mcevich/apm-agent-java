 ...
 */
@VisibleForAdvice
public class ValveTransactionHelper {

    private static final String CONTENT_TYPE_FROM_URLENCODED = "application/x-www-form-urlencoded";

    private final Logger logger = LoggerFactory.getLogger(ValveTransactionHelper.class);
    ...
    @VisibleForAdvice
    public ValveTransactionHelper(ElasticApmTracer tracer) {
        this.tracer = tracer;
